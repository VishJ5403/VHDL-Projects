...
SIGNAL \add_instance|n1|Y~0_combout\ : std_logic;
SIGNAL \input_vector~combout\ : std_logic_vector(3 DOWNTO 0);
SIGNAL \add_instance|n1|ALT_INV_Y~0_combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\add_instance|n1|ALT_INV_Y~0_combout\ <= NOT \add_instance|n1|Y~0_combout\;
...
\add_instance|n1|Y~0\ : maxv_lcell
-- Equation(s):
-- \add_instance|n1|Y~0_combout\ = (\input_vector~combout\(0)) # (\input_vector~combout\(1) $ (((\input_vector~combout\(2) & \input_vector~combout\(3)))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \add_instance|n1|Y~0_combout\);
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|n1|ALT_INV_Y~0_combout\,
	oe => VCC,
