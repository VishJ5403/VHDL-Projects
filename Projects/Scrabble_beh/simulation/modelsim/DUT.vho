...
-- Equation(s):
-- \add_instance|O~0_combout\ = (\input_vector~combout\(0) & (!\input_vector~combout\(1) & (\input_vector~combout\(3) $ (!\input_vector~combout\(2))))) # (!\input_vector~combout\(0) & (\input_vector~combout\(1) & (\input_vector~combout\(3) $ 
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|O~0_combout\,
	oe => VCC,
