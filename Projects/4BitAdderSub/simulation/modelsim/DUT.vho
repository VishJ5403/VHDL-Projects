...
SIGNAL \add_instance|X~combout\ : std_logic;
...
\add_instance|X\ : maxv_lcell
-- Equation(s):
-- \add_instance|X~combout\ = (\input_vector~combout\(0) $ (((\input_vector~combout\(2)))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \add_instance|X~combout\);
...
-- Equation(s):
-- \add_instance|FA2|x1|Y~combout\ = \add_instance|X~combout\ $ (\input_vector~combout\(6) $ (((\add_instance|FA1|a1|Y~combout\) # (\add_instance|FA1|ha|C~combout\))))
...
-- Equation(s):
-- \add_instance|FA2|o1|Y~0_combout\ = (\add_instance|X~combout\ & ((\add_instance|FA1|a1|Y~combout\) # ((\input_vector~combout\(6)) # (\add_instance|FA1|ha|C~combout\)))) # (!\add_instance|X~combout\ & (\input_vector~combout\(6) & 
