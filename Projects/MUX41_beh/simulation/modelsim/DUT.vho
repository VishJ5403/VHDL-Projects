...
SIGNAL \add_instance|Y[3]~6_combout\ : std_logic;
...
-- Equation(s):
-- \add_instance|Y[0]~0_combout\ = (\input_vector~combout\(0) & ((\input_vector~combout\(6)) # ((\input_vector~combout\(1))))) # (!\input_vector~combout\(0) & (((\input_vector~combout\(2) & !\input_vector~combout\(1)))))
...
-- Equation(s):
-- \add_instance|Y[0]~1_combout\ = (\add_instance|Y[0]~0_combout\ & (((\input_vector~combout\(14))) # (!\input_vector~combout\(1)))) # (!\add_instance|Y[0]~0_combout\ & (\input_vector~combout\(1) & (\input_vector~combout\(10))))
...
-- Equation(s):
-- \add_instance|Y[1]~2_combout\ = (\input_vector~combout\(0) & (((\input_vector~combout\(1))))) # (!\input_vector~combout\(0) & ((\input_vector~combout\(1) & ((\input_vector~combout\(11)))) # (!\input_vector~combout\(1) & (\input_vector~combout\(3)))))
...
-- Equation(s):
-- \add_instance|Y[1]~3_combout\ = (\add_instance|Y[1]~2_combout\ & (((\input_vector~combout\(15)) # (!\input_vector~combout\(0))))) # (!\add_instance|Y[1]~2_combout\ & (\input_vector~combout\(7) & (\input_vector~combout\(0))))
...
-- pragma translate_on
PORT MAP (
	dataa => \add_instance|Y[1]~2_combout\,
...
-- Equation(s):
-- \add_instance|Y[2]~4_combout\ = (\input_vector~combout\(0) & ((\input_vector~combout\(8)) # ((\input_vector~combout\(1))))) # (!\input_vector~combout\(0) & (((\input_vector~combout\(4) & !\input_vector~combout\(1)))))
...
-- Equation(s):
-- \add_instance|Y[2]~5_combout\ = (\add_instance|Y[2]~4_combout\ & ((\input_vector~combout\(16)) # ((!\input_vector~combout\(1))))) # (!\add_instance|Y[2]~4_combout\ & (((\input_vector~combout\(12) & \input_vector~combout\(1)))))
...
\add_instance|Y[3]~6\ : maxv_lcell
-- Equation(s):
-- \add_instance|Y[3]~6_combout\ = (\input_vector~combout\(0) & (\input_vector~combout\(1))) # (!\input_vector~combout\(0) & ((\input_vector~combout\(1) & ((\input_vector~combout\(13)))) # (!\input_vector~combout\(1) & (\input_vector~combout\(5)))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \add_instance|Y[3]~6_combout\);
...
-- Equation(s):
-- \add_instance|Y[3]~7_combout\ = (\add_instance|Y[3]~6_combout\ & ((\input_vector~combout\(17)) # ((!\input_vector~combout\(0))))) # (!\add_instance|Y[3]~6_combout\ & (((\input_vector~combout\(0) & \input_vector~combout\(9)))))
...
PORT MAP (
	...
	datab => \add_instance|Y[3]~6_combout\,
	datac => \input_vector~combout\(0),
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|Y[2]~5_combout\,
	oe => VCC,
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|Y[3]~7_combout\,
	oe => VCC,
